...
pub(crate) fn get_global_proxy_url_internal(state: &AppState) -> Result<Option<String>, String> {
...
pub(crate) fn set_global_proxy_url_internal(state: &AppState, url: String) -> Result<(), String> {
...
pub(crate) async fn test_proxy_url_internal(url: String) -> Result<ProxyTestResult, String> {
...
pub(crate) fn get_upstream_proxy_status_internal() -> UpstreamProxyStatus {
...
/// 检测常见端口是否有代理服务在运行。
/// 使用异步任务避免阻塞 UI 线程。
pub(crate) async fn scan_local_proxies_internal() -> Vec<DetectedProxy> {
