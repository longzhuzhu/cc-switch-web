...
pub fn get_global_proxy_url(state: crate::command_state::State<'_, AppState>) -> Result<Option<String>, String> {
...
pub fn set_global_proxy_url(state: crate::command_state::State<'_, AppState>, url: String) -> Result<(), String> {
