...
現在の Web ブランチでは、次のデスクトップ機能をそろえています。
...
| Windows 上で成果物を出力 | `.\scripts\package-artifacts.ps1 [all|w|l|d]` |
...
引数を省略すると、次の 3 種類の成果物をまとめて生成します。
